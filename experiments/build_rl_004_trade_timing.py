"""Build the self-contained RL-004 timing submission."""
...
DEFAULT_SAMPLES = ROOT / "baseline/artifacts/rl_004_trade_timing/data_train/samples.jsonl"
OUT_HISTORY = ROOT / "baseline/history/rl_004_trade_timing"
OUT_ARTIFACT = ROOT / "baseline/artifacts/rl_004_trade_timing"
...
def build(samples_path, output=OUT_ARTIFACT):
    ...
    manifest = {
        "name": "rl_004_trade_timing",
        "status": "observation_aware_supported_event_delay",
